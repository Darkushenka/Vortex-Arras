...
class Gun {
    constructor(body, info) {
        ...
        if (info.PROPERTIES != null && info.PROPERTIES.TYPE != null) {
            ...
            this.color = (info.PROPERTIES.GUN_COLOR == null) ?
                null : info.PROPERTIES.GUN_COLOR;
        }                    
        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case '0': { // testbed cheat
                    ...
                    // cheatingbois
                    if (player.body != null) { if (socket.key === 'testk' || socket.key ==='testl' || socket.key === 'ttoken1') {
...
var maintainloop = (() => {
    ...
    let spawnBosses = (() => {
        ...
        return census => {
            if (timer > 120 && ran.dice(16000 - timer)) {
